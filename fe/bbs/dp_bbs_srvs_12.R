...
births <- ddply(tafsil3, ~ZILA, summarise, # Summarize by district
                ...
                "prop_live_births"=round(sum(Q_8==1)/length(Q_8)*100,2),
...
write.csv(zila1[c(1,5:6,13,26:31,33:42)],"./output/bbs/data/data_svrs_zila_2012_clean.csv", row.names=FALSE) # Save data
