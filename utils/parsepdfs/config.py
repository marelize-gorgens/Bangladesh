class Config:
    parse_parameters = {'C01': {'ncol_before':6, 'ncol_after':5},
                        ...
                        'C10': {'ncol_before':6, 'ncol_after':9},
                        'C11': {'ncol_before':6, 'ncol_after':10},
                        'C12': {'ncol_before':6, 'ncol_after':12},
    ...
    cols_dict = {'C01': ['ZL', 'UZ', 'UN/WA', 'MZ/MH', 'Vill', 'RMO',
                 ...
                 'C07': ['ZL', 'UZ', 'UN/WA', 'MZ/MH', 'Vill', 'RMO',
                         ...
                         'Population aged 3-5 years-Not attending school-Male','Population aged 3-5 years-Not attending school-Female',
                         'Population aged 6-10 years-Attending school-Male','Population aged 6-10 years-Attending school-Female',
                         'Population aged 6-10 years-Not attending school-Male','Population aged 6-10 years-Not attending school-Female',
                         'Population aged 11-14 years-Attending school-Male','Population aged 11-14 years-Attending school-Female',
                         'Population aged 11-14 years-Not attending school-Male','Population aged 11-14 years-Not attending school-Female',],
                 'C08': ['ZL', 'UZ', 'UN/WA', 'MZ/MH', 'Vill', 'RMO',
                         ...
                         'Population aged 15-19 years-Not attending school-Male','Population aged 15-19 years-Not attending school-Female',
                         'Population aged 20-24 years-Attending school-Male','Population aged 20-24 years-Attending school-Female',
                         'Population aged 20-24 years-Not attending school-Male','Population aged 20-24 years-Not attending school-Female',
                         'Population aged 25-29 years-Attending school-Male','Population aged 25-29 years-Attending school-Female',
                         'Population aged 25-29 years-Not attending school-Male','Population aged 25-29 years-Not attending school-Female',],
                 ...
                 'C10': ['ZL', 'UZ', 'UN/WA', 'MZ/MH', 'Vill', 'RMO', 
                         'Administrative Unit Residence Community',
                         'Population aged 7+ and not attending school-Both', 'Population aged 7+ and not attending school-Male', 'Population aged 7+ and not attending school-Female' ,
                 ...
                 # 'C12_e': ['ZL', 'UZ', 'UN/WA', 'MZ/MH', 'Vill', 'RMO',
                         'Administrative Unit Residence Community', 
                         'Ethnic-Households','Ethnic-Population-Both','Ethnic-Population-Male', 'Ethnic-Population-Female',
                 ...
                 'C14': ['ZL', 'UZ', 'UN/WA', 'MZ/MH', 'Vill', 'RMO',
                         ...
                         'Toilet Facility (%)-Sanitary (water-sealed)', 'Toilet Facility (%)-Sanitary (non water-sealed)',
                         'Toilet Facility (%)-Non-sanitary', 'Toilet Facility (%)-None',],
                 'C15': ['ZL', 'UZ', 'UN/WA', 'MZ/MH', 'Vill', 'RMO',
                         'Administrative Unit Residence Community', 
                         'Number of Households', 
                         'Source of Drinking Water (%)-Tap',  'Source of Drinking Water (%)-Tube-Well',  'Source of Drinking Water (%)-Other',
